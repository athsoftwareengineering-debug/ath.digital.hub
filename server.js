...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .orders-list, .users-list { display: flex; flex-direction: column; gap: 12px; margin-bottom: 16px; }
...
<div id="app">
    ...
    <div class="bottom-nav" id="bottomNav" style="display: none;">
        <button class="nav-item active" data-tab="menu"><i class="fas fa-chart-line"></i><span>မီနူး</span></button>
...
(function() {
    ...
    let autoSyncInterval = null, countdownInterval = null;
    let secondsLeft = 30;
    ...
    function startAutoSync() {
        ...
        secondsLeft = 30;
        countdownInterval = setInterval(() => { secondsLeft--; if (secondsLeft < 0) secondsLeft = 30; }, 1000);
    ...
    // ============ SALES HOURS CONTROL WITH AUTO/MANUAL MODE ============
    ...
    async function updateSalesHoursWithMode(mode) {
        ...
        const manualStatus = document.getElementById('manualToggle')?.checked || true;
